import math
from lib.models.rdtt import build_rdttrack
...
class RDTTrack(BaseTracker):
    def __init__(self, params):
        super(RDTTrack, self).__init__(params)
        network = build_rdttrack(params.cfg, training=False)
